...
public class BagriXQDataSourceTest {
    ...
    public void setUp() throws XQException {
	    ...
	    xqds.setProperty(BagriXQDataSource.ADDRESS, "localhost:10000");
	    xqds.setProperty(BagriXQDataSource.SCHEMA, "TPoX");
	    xqds.setProperty(BagriXQDataSource.PASSWORD, "TPoX");
