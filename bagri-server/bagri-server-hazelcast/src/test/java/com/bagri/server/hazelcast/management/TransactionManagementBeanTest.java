...
public class TransactionManagementBeanTest extends ManagementBeanTest {
	...
	protected ObjectName getObjectName() throws MalformedObjectNameException {
        return new ObjectName("com.bagri.db:type=Schema,name=default,kind=TransactionManagement");
	}
	...
	protected String[] getExpectedOperations() {
		return new String[] {"getSchema", "getTxStatistics", "getInFlightTransactions", "beginTransaction", "commitTransaction", 
				"rollbackTransaction", "resetStatistics", "getTransactionTimeout", "setTransactionTimeout"};
	}
