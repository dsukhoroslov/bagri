...
public class ResourceManagementBeanTest extends ManagementBeanTest {
	...
	protected ObjectName getObjectName() throws MalformedObjectNameException {
        return new ObjectName("com.bagri.db:type=Schema,name=default,kind=ResourceManagement");
	}
	...
	protected String[] getExpectedOperations() {
		return new String[] {"getSchema", "getResources", "getResourceStatistics", "addResource", "dropResource", "enableResource", 
				"reloadResources"};
	}
