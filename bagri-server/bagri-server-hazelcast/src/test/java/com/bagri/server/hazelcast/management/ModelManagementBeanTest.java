...
public class ModelManagementBeanTest extends ManagementBeanTest {
	...
	protected ObjectName getObjectName() throws MalformedObjectNameException {
        return new ObjectName("com.bagri.db:type=Schema,name=default,kind=ModelManagement");
	}
	...
	protected Map<String, Object> getExpectedAttributes() {
		...
		map.put("PathStatistics", null);
		return map;
	}
	
	@Override
	protected String[] getExpectedOperations() {
		return new String[] {"getSchema", "getFragments", "addFragment", "removeFragment", "enableFragment", "getPathsForRoot", 
				"getPathStatistics", "registerModel", "registerModels", "aggregatePath"};
	}
