		...
		public void run() {
			...
			try {
				for (int i=0; i < loops; i++) {
					...
					//storeSecurityTest();
					uris.add(updateDocumentTest(0, null, sampleRoot + getFileName("security1500.xml")).getUri());
					uris.add(updateDocumentTest(0, null, sampleRoot + getFileName("security5621.xml")).getUri());
					uris.add(updateDocumentTest(0, null, sampleRoot + getFileName("security9012.xml")).getUri());
