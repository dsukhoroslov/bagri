...
public class MarkLogicXCCPlugin extends BagriTPoXPlugin {
	...
	@Override
	protected int execCommand(String command, Map<String, XDMParameter> params) throws RequestException {
	...
	private void bindParams(Map<String, XDMParameter> params, Request request) { //throws RequestException {
	...
	@Override
	protected int execQuery(String query, Map<String, XDMParameter> params) throws RequestException {
