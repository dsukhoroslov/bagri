...
public class XDMElementCacheStore implements MapStore<DataDocumentKey, XDMElement> {
	...
	public Map<DataDocumentKey, XDMElement> loadAll(Collection<DataDocumentKey> keys) {
		...
		Map<DataDocumentKey, XDMElement> result2 = new HashMap<DataDocumentKey, XDMElement>(result.size());
		for (Object o: result.entrySet()) {
			Map.Entry e = (Map.Entry) o;
			DataDocumentKey key = mc.read(DataDocumentKey.class, (DBObject) e.getKey());
	...
	@Override
	public Set<DataDocumentKey> loadAllKeys() {
