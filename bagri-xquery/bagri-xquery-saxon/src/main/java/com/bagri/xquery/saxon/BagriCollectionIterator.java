...
public class BagriCollectionIterator implements SequenceIterator<Item>, 
	GroundedIterator<Item>, LastPositionFinder<Item>, LookaheadIterator<Item> {
	
    private static final Logger logger = LoggerFactory.getLogger(BagriCollectionIterator.class);
	...
	public BagriCollectionIterator(XDMDocumentManagement dataMgr, ExpressionContainer query) {
