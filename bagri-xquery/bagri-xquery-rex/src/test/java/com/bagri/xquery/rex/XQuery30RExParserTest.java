...
import com.bagri.xquery.rex.XQuery30RExParser.ParseException;
import com.bagri.xquery.rex.XQuery30RExParser.XmlSerializer;

public class XQuery30RExParserTest {
	...
	public void testParse_XQuery() throws IOException {
        ...
        XQuery30RExParser parser = new XQuery30RExParser(query, s);
        try
        {
