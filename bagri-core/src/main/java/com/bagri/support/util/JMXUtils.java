...
import com.bagri.support.security.LocalSubject;
...
public class JMXUtils {
	...
	public static final String domain = "com.bagri.db";
	public static final String type_management = "Management";
    
	/**
	 * Registers system-specific MBean in domain {@code com.bagri.db} with type {@code Management} 
	 * 
	...
	/**
	 * Registers system-specific MBean in domain {@code com.bagri.db}  
	 * 
	 * @param name the MBean name
	...
	/**
	 * Registers MBean under {@code com.bagri.db} domain
	 * 
	...
	/**
	 * Produce JMX ObjectName from the MBean type and name provided. Uses {@code com.bagri.db} as domain name 
	 * 
	 * @param type the MBean type
	 * @param name the MBean name
	...
	/**
	 * Produce JMX ObjectName from the MBean keys provided. Uses {@code com.bagri.db} as domain name
	 * 
	...
	/**
	 * Produce JMX ObjectName from the MBean keys provided as String. Uses {@code com.bagri.db} as domain name
	 * 
	...
	/**
	 * Unregisters MBean from JMX repository. Uses {@code com.bagri.db} domain
	 * 
	 * @param keys the MBean keys
