...
public class Constants {
	...
	public static final String pn_client_idCount = "bdb.client.idCount";
    ...
    public static final String pn_schema_population_chunk_size = "bdb.schema.population.chunk.size";
