...
public interface DocumentAccessor {
	...
	static long HDR_DOCUMENT_INFO     = HDR_COLLECTIONS | HDR_CONTENT_TYPE | HDR_ENCODING | HDR_CREATED_AT | HDR_CREATED_BY | HDR_KEY | HDR_SIZE_IN_BYTES | 
										HDR_SIZE_IN_ELEMENTS | HDR_SIZE_IN_FRAGMENTS |	HDR_TX_START | HDR_TX_FINISH | HDR_URI | HDR_VERSION;
